...
output1 = cv2.applyColorMap(output, cv2.COLORMAP_BONE)
output2 = cv2.applyColorMap(output1, cv2.COLORMAP_JET)
output3 = cv2.applyColorMap(output2, cv2.COLORMAP_OCEAN)
